    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            <ul id="hd_nb">
                ...
                <li class="hd_nb3"><a href="<?php echo G5_BBS_URL ?>/current_connect" id="snb_cnt"><i class="fa fa-users" aria-hidden="true"></i>접속자 <span><?php echo connect('basic'); // 현재 접속자수 ?></span></a></li>
