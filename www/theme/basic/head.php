    ...
    <div id="tnb">
    	<div class="inner">
            ...
            <ul id="hd_qnb">
	            ...
	            <li><a href="<?php echo G5_BBS_URL ?>/current_connect" class="visit">접속자<strong class="visit-num"><?php echo connect('theme/basic'); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정  ?></strong></a></li>
	        </ul>
		</div>
    </div>
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_URL ?>/static/img/logo/gnuboard.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        ...
        <ul class="hd_login">        
            <?php if ($is_member) {  ?>
            <li><a href="<?php echo G5_BBS_URL ?>/member_confirm?url=<?php echo G5_BBS_URL ?>/register_form">정보수정</a></li>
            <li><a href="<?php echo G5_BBS_URL ?>/logout">로그아웃</a></li>
            <?php if ($is_admin) {  ?>
            <li class="tnb_admin"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">관리자</a></li>
            <?php }  ?>
            <?php } else {  ?>
            <li><a href="<?php echo G5_BBS_URL ?>/register">회원가입</a></li>
            <li><a href="<?php echo G5_BBS_URL ?>/login">로그인</a></li>
            <?php }  ?>
