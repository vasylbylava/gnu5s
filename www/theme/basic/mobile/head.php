    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            <ul id="hd_nb">
                ...
                <li class="hd_nb3"><a href="<?php echo G5_BBS_URL ?>/current_connect" id="snb_cnt"><i class="fa fa-users" aria-hidden="true"></i>접속자 <span><?php echo connect('theme/basic'); // 현재 접속자수 ?></span></a></li>
                <li class="hd_nb4"><a href="<?php echo G5_BBS_URL ?>/new" id="snb_new"><i class="fa fa-history" aria-hidden="true"></i>새글</a></li>   
            </ul>
        </div>
