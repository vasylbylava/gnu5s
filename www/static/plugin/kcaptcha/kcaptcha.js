$(function(){
    ...
    $(document).on( "click", "#captcha_reload", function(){
        $.ajax({
            type: 'POST',
            url: g5_captcha_url+'/kcaptcha_session',
            cache: false,
            async: false,
            success: function(text) {
                $('#captcha_img').attr('src', g5_captcha_url+'/kcaptcha_image?t=' + (new Date).getTime());
            }
        });

        $.ajax({
            type: 'POST',
            url: g5_captcha_url+'/kcaptcha_mp3',
            cache: false,
            async: false,
...
function chk_captcha()
{
    ...
    $.ajax({
        type: 'POST',
        url: g5_captcha_url+'/kcaptcha_result',
        data: {
