    ...
    <section id="smb_my_ov">
        ...
        <div class="my_name">
            ...
            <ul class="smb_my_act">
                ...
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm?url=register_form" class="btn01">정보수정</a></li>
        ...
        <ul class="my_pocou">
            <li  class="my_cou">
                보유쿠폰
                <a href="<?php echo G5_SHOP_URL; ?>/coupon" target="_blank" class="win_coupon"><?php echo number_format($cp_count); ?></a>
            </li>
            <li class="my_point">
                보유포인트
                <a href="<?php echo G5_BBS_URL; ?>/point" target="_blank" class="win_point"><?php echo number_format($member['mb_point']); ?>점</a>
            </li>
        </ul>
        <div class="my_info">
