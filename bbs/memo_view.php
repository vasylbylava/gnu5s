...
$del_link = 'memo_delete?me_id='.$memo['me_id'].'&amp;token='.$token.'&amp;kind='.$kind;
...
if (isset($prev['me_id']) && $prev['me_id']) {
    $prev_link = './memo_view?kind='.$kind.'&amp;me_id='.$prev['me_id'];
...
if (isset($next['me_id']) && $next['me_id']) {
    $next_link = './memo_view?kind='.$kind.'&amp;me_id='.$next['me_id'];
