...
define('G5_NO_PROFILE_IMG', '<span class="profile_img"><img src="'.G5_URL.'/static/img/no_profile.gif" alt="no_profile" width="'.$config['cf_member_icon_width'].'" height="'.$config['cf_member_icon_height'].'"></span>');
