    ...
    <div id="tnb">
        <div class="inner">
			...
			<ul id="hd_qnb">
	            ...
	            <li><a href="<?php echo G5_BBS_URL ?>/current_connect" class="visit">접속자<strong class="visit-num"><?php echo connect(); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정 ?></strong></a></li>
	        </ul>
		</div>
    </div>
    <div id="hd_wrapper">
