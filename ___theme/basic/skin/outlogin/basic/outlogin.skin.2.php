...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <a href="<?php echo G5_BBS_URL ?>/member_confirm?url=register_form" id="ol_after_info" title="정보수정">정보수정</a>
    ...
    <ul id="ol_after_private">
    	<li>
            <a href="<?php echo G5_BBS_URL ?>/point" target="_blank" id="ol_after_pt" class="win_point">
				<i class="fa fa-database" aria-hidden="true"></i>포인트
				<strong><?php echo $point; ?></strong>
            </a>
        </li>
        <li>
            <a href="<?php echo G5_BBS_URL ?>/memo" target="_blank" id="ol_after_memo" class="win_memo">
    ...
    <footer>
    	<a href="<?php echo G5_BBS_URL ?>/logout" id="ol_after_logout"><i class="fa fa-sign-out" aria-hidden="true"></i> 로그아웃</a>
    </footer>
</section>
