...
<header id="hd">
    ...
    <div id="hd_top">
        ...
        <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_URL ?>/static/adm/img/logo.png" alt="<?php echo get_text($config['cf_title']); ?> 관리자"></a></div>
        ...
        <div id="tnb">
            <ul>
                ...
                <li class="tnb_li"><a href="<?php echo G5_ADMIN_URL ?>/service" class="tnb_service">부가서비스</a></li>
                <li class="tnb_li"><button type="button" class="tnb_mb_btn">관리자<span class="./img/btn_gnb.png">메뉴열기</span></button>
                    <ul class="tnb_mb_area">
                        <li><a href="<?php echo G5_ADMIN_URL ?>/member_form?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>">관리자정보</a></li>
                        <li id="tnb_logout"><a href="<?php echo G5_BBS_URL ?>/logout">로그아웃</a></li>
                    </ul>
                </li>
            </ul>
        </div>
