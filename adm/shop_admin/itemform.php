...
<form name="fitemform" action="./itemformupdate" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return fitemformcheck(this)">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemqalist?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
